  ...
  render() {
    ...
    if (this.props.loginData.isLoggedIn === false) {
        output = <form className = 'signIn'>
                      ...
                      onChange = {e => {this.props.editHandler(e.target.value, 'username')}}
                      />
                      ...
                      onChange = {e => {this.props.editHandler(e.target.value, 'password')}}
                      />
                      ...
                      type='button' 
                      value = 'submit' 
                      onClick = {() => {this.props.processLogin(this.props.loginData.username, this.props.loginData.password)}} 
                      />
